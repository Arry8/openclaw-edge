...
export const zh_CN: TranslationMap = {
  ...
  usage: {
    page: {
      subtitle: "查看 Token 去向、会话高峰时段及成本驱动因素。",
    },
    common: {
      emptyValue: "—",
      unknown: "未知",
    ...
    query: {
      ...
      inRange: "范围内 {total} 个会话",
      tip: "提示：使用筛选器或点击柱状图细化日期。",
    },
    export: {
      label: "导出",
      sessionsCsv: "会话 CSV",
    ...
    empty: {
      title: "选择日期范围开始",
      subtitle: "加载使用数据以对比费用、检查会话并深入时间线分析，无需离开仪表盘。",
    ...
    overview: {
      ...
      avgCost: "平均费用 / 消息",
      avgCostHint: "当提供商报告费用时每条消息的平均费用。",
      avgCostHintMissing:
        "当提供商报告费用时每条消息的平均费用。此范围内部分或全部会话缺少费用数据。",
      acrossMessages: "涵盖 {count} 条消息",
      sessions: "会话",
      sessionsHint: "范围内的不同会话数。",
      sessionsInRange: "范围内共 {count} 个",
      throughput: "吞吐量",
      throughputHint: "吞吐量显示活跃时间内每分钟的 Token 数。数值越高越好。",
      tokensPerMinute: "tok/min",
      perMinute: "/ 分钟",
      errorRate: "错误率",
      errorHint: "错误率 = 错误数 / 总消息数。数值越低越好。",
      avgSession: "平均会话",
      cacheHitRate: "缓存命中率",
      cacheHint: "缓存命中率 = 缓存读取 / (输入 + 缓存读取)。数值越高越好。",
      cached: "已缓存",
      prompt: "提示",
      calls: "次调用",
      topModels: "热门模型",
    ...
    sessions: {
      ...
      copy: "复制",
      copyName: "复制会话名称",
      limitReached: "显示前 1,000 个会话。缩小日期范围以获取完整结果。",
    },
    details: {
      ...
      you: "你",
      noMessagesMatch: "没有消息匹配当前筛选。",
    },
    mosaic: {
      title: "按时间分布",
      subtitleEmpty: "需要会话时间戳以生成估算。",
      subtitle: "基于会话时间跨度（首次/末次活动）估算。时区：{zone}。",
  ...
  cron: {
    ...
    timeline: {
      ...
      zoomNow: "现在±3h",
      alwaysOn: "始终运行",
      clickHistory: "点击 → 查看运行历史",
      clickDetails: "点击 → 查看作业详情",
      viewDetails: "查看作业详情",
      viewHistory: "查看运行历史",
      runNow: "立即运行",
      pending: "待运行",
