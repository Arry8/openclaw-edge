...
export const de: TranslationMap = {
  ...
  cron: {
    timeline: {
      ...
      clickHistory: "Klick → Ausführungsverlauf anzeigen",
      clickDetails: "Klick → Job-Details anzeigen",
      viewDetails: "Job-Details anzeigen",
      viewHistory: "Ausführungsverlauf anzeigen",
