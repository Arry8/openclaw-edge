...
export const es: TranslationMap = {
  ...
  cron: {
    ...
    timeline: {
      ...
      clickHistory: "Clic → ver historial de ejecuciones",
      clickDetails: "Clic → ver detalles del trabajo",
      viewDetails: "Ver detalles del trabajo",
      viewHistory: "Ver historial de ejecuciones",
