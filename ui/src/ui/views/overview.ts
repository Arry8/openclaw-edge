                ...
                <label class="field">
                  ...
                  <div style="position: relative;">
                    ...
                    <button
                      ...
                      style="position: absolute; right: 0px; top: 50%; transform: translateY(-50%); width: 40px; height: 40px; padding: 0; display: inline-flex; align-items: center; justify-content: center; z-index: 1;"
