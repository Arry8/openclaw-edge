...
const OBFUSCATION_PATTERNS: ObfuscationPattern[] = [
  ...
  },
  {
    ...
    regex:
      /(?:python[23]?|perl|ruby)\s+-[ec]\s+.*(?:base64.*b64decode|b64decode|base64\.b64|frombase64|fromb64)/i,
  },
  {
    id: "curl-pipe-shell",
  ...
  },
  {
    ...
    description:
      "Variable assignment chain with expansion into execution context (potential obfuscation)",
    regex:
