...
const TAGLINES: string[] = [
  ...
  "Runs on your server, respects your privacy, pinches your productivity.",
  "I don't need coffee—I run on webhooks and existential dread.",
  "Your config files called—they want a backup.",
