...
export const FIELD_HELP: Record<string, string> = {
  ...
  "diagnostics.otel.includeContent":
    "Include message content (input prompts and output responses) in OTEL trace spans. Required for Langfuse evaluators. Sends actual text to your OTEL backend — ensure your backend's data policies allow this. Default: false.",
