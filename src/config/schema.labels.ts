...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "gateway.auth.scopes": "Gateway Auth Token Scopes",
  ...
  "tools.web.x_search.baseUrl": "X Search Base URL",
  ...
  "cron.webhookSsrfPolicy": "Cron Webhook SSRF Policy",
  "cron.webhookSsrfPolicy.dangerouslyAllowPrivateNetwork": "Cron Webhook Allow Private Network",
  "cron.webhookSsrfPolicy.allowedHostnames": "Cron Webhook Allowed Hostnames",
  hooks: "Hooks",
